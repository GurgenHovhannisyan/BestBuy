...
namespace BestBuy.Controllers
{
    ...
    {
        private MicrowavesViewModel mictowaveViewModel;
        ...
        public IActionResult GetAllFoodProcessors()
        {
            ...
            foreach (FoodProcessor entity in foodprocList)
            {
                ...
                entity.FoodProcessorNumberOfSpeed, entity.FoodProcessorNumberOfFunction, entity.FoodProcessorAvailability, entity.FoodProcessorColor, entity.FoodProcessorDate, entity.ImageAsBase64);
        ...
        public IActionResult GetAllCoffeeMakers()
        {
            ...
            {
                CoffeeMakerViewModel cmViewModel = new CoffeeMakerViewModel(entity.CoffeeMakerModel, entity.CoffeeMakerPower, entity.CoffeeMakerType, entity.CoffeeMakerFilter, entity.CoffeeMakerPrice,
                entity.CoffeeMakerAvailability, entity.CoffeeMakerColor, entity.CoffeeMakerDate, entity.ImageAsBase64);
        ...
        public IActionResult GetAllJuicers()
        {
            ...
            foreach (Juicer entity in juicerList)
            {
                ...
                entity.JuicerVolme, entity.JuicerAvailability, entity.JuicerColor, entity.JuicerDate, entity.ImageAsBase64);
        ...
        public IActionResult GetAllKettles()
        {
            ...
            foreach (Kettle entity in kettleList)
            {
                ...
                entity.KettleAvailability, entity.KettleColor, entity.KettleDate, entity.ImageAsBase64);

                kettleViewModelList.Add(kettleViewModel);
            }
        ...
        public IActionResult GetAllMicrowaves()
        {
            ...
            foreach (Microwave entity in microwaveList)
            {
                ...
                microwaveViewModelList.Add(mictowaveViewModel);
            }
        ...
        public IActionResult GetAllMixers()
        {
            ...
            foreach (Mixer entity in mixerList)
            {
                MixerViewModel mixerViewModel = new MixerViewModel(entity.MixerModel, entity.MixerPower, entity.MixerPrice, entity.MixerNumberOfSpeed, entity.MixerBowel,
                    entity.MixerAvailability, entity.MixerColor, entity.MixerDate, entity.ImageAsBase64);
                mixerViewModelList.Add(mixerViewModel);
            }
